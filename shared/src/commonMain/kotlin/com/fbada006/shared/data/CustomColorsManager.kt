...
import com.fbada006.shared.data.PreferenceKeys.PREF_CUSTOM_COLORS
...
internal class CustomColorsManager(private val preferences: DataStore<Preferences>) {
    ...
    suspend fun getColors(): Flow<List<Int>> = flow {
