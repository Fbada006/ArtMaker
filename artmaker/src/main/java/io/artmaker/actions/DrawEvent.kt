...
sealed interface DrawEvent {
    data class AddNewShape(val offset: Offset, val pressure: Float = 1.0f) : DrawEvent
    data class UpdateCurrentShape(val offset: Offset, val pressure: Float = 1.0f) : DrawEvent
